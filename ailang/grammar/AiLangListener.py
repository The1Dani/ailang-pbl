...
class AiLangListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by AiLangParser#get_operation.
    def enterGet_operation(self, ctx:AiLangParser.Get_operationContext):
        pass

    # Exit a parse tree produced by AiLangParser#get_operation.
    def exitGet_operation(self, ctx:AiLangParser.Get_operationContext):
        pass
    ...
    # Enter a parse tree produced by AiLangParser#get_stat.
    def enterGet_stat(self, ctx:AiLangParser.Get_statContext):
        pass

    # Exit a parse tree produced by AiLangParser#get_stat.
    def exitGet_stat(self, ctx:AiLangParser.Get_statContext):
        pass
